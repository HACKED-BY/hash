...
system("python2 -m pip install colorama")

print """
hash cracker version 1.0

coded by M R - D A R K

Telegram: https://t.me/Firabil45
...
try:
	...
	for password in wordlist:
		...
		if hashing == hash_a:
			print Fore.LIGHTWHITE_EX+"[+] Fund: "+Fore.LIGHTGREEN_EX,password
			break
		else:
			print Fore.LIGHTWHITE_EX+"[-] Not Fund: "+Fore.LIGHTRED_EX,password
			sleep(0.5)
except:
	print Fore.LIGHTYELLOW_EX+"[!] Please check input "
